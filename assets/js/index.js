...
// *)
const a = Number(prompt('Введіть перше значення:'));
const b = Number(prompt('Введіть друге значення:'));
const c = Number(prompt('Введіть трєте значення:'));
...
if (d>0) {
    ...
    console.log('Якщо d>0 ', res1, res2);
} else if (d===0) {
    const res3 = -b/2*a;
    console.log('Якщо d=0 ', res3);
} else if (d<0) {
